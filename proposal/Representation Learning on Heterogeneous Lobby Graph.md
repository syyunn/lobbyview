...
Find the best [contextualized representaion](https://kawine.github.io/blog/nlp/2020/02/03/contextual.html) for given subgraph sampled from the ***Lobby Graph*** that well performs downstream tasks, such as "Bill pass prediction", "Interest Group detection or classification", etc.
